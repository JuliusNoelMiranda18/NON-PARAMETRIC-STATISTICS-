...
3. **Five-Number Summary & Boxplot**: Computes quartiles (\(Q_1\), \(Q_2\), \(Q_3\)), Interquartile Range (\(IQR\)), and outlier fences (\(Q_1 - 1.5 \IQR\) and \(Q_3 + 1.5 \IQR\)) to generate a boxplot.
